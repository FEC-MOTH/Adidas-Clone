module.exports.genders = ['Men', 'Women', 'Children'];
module.exports.sports = ['Originals', 'Running', 'Soccer', 'Basketball', 'Football', 'Skateboarding', 'Workout', 'Essentials', 'Sandals & Slides', 'Hiking', 'Golf', 'Tennis', 'Baseball'];
