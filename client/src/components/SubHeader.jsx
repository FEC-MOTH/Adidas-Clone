...
const SubHeader = (props) => (
  <div className={styles.subHeader}>
    <div className={styles.subHeaderItemsWrapper}>
      ...
      <div className={styles.subHeaderItem}>
        <img className={styles.subHeaderItemImage} src={process.env.CDN_ROOT.concat('/assets/img/subHeader/adidas_icon_creatorID_WHITE_v6.png')} alt="CREATORS GET REWARDED – JOIN THE NEW ADIDAS CREATORS CLUB" />
